...
var cartCounter = document.querySelector("#cartCounter"); // Update Cart

function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", pizza).then(function (res) {
    console.log(res);
    cartCounter.innerText = res.data.totalQty; // JavaScript library for toast notifications
...
var statuses = document.querySelectorAll(".status-line"); // console.log(statuses);
...
socket.on("orderUpdated", function (data) {
  ...
  updateStatus(updatedOrder); // JavaScript library for toast notifications
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51InhaNSH8wugdTbMQ1b8448LDQ5WcS4VFGVU3CC5n8MrgMQyNm9jF7lox5fjKzzKskxcbhIBx5aPrnZwxSouudmj00TFkbzt1s");

          case 3:
            stripe = _context2.sent;
            card = null; // Mount Widget
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          // Ajax Call
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_2__.placeOrder)(formObject); // console.log(formObject);
                        ...
                        case 10:
                          ...
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_2__.placeOrder)(formObject); // stripe
                          //   .createToken(card)
                          //   .then((result) => {
                          //     //   console.log(result);
...
/******/ 	__webpack_require__.O(undefined, ["public/css/style"], () => (__webpack_require__("./resources/js/script.js")))
